    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-white p-6 rounded shadow">
          <p className="text-red-600">No token found. Please verify OTP again.</p>
          <Link to="/forgot-password" className="text-purple-600 hover:underline block mt-2">Back</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-white flex flex-col justify-center items-center py-12 px-4">
      <div className="w-full max-w-md bg-black rounded-3xl shadow-2xl p-8 flex flex-col items-center">
        ...
        <form className="w-full flex flex-col gap-5" onSubmit={handleReset}>
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-red-200 mb-1">
              New Password
            </label>
            <input
              id="password"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-red-200 mb-1">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
